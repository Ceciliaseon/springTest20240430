...
<div class="container-md">
	...
	<form action="/member/modify" method="post">
		...
		<div class="mb-3">
		  ...
		  <input type="text" class="form-control" name="reg_date" id="i" readonly="readonly" value="${ses.reg_date }" placeholder="Reg_Date...">
		</div>	
		<div class="mb-3">
		  <label for="i" class="form-label">Last_login</label>
		  <input type="text" class="form-control" name="last_login" id="i" readonly="readonly" value="${ses.last_login }" placeholder="last_login...">
		</div>	
		<div class="mb-3">
